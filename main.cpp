...
void face_collect() {
    //使用官方训练的模型
    String path = "/Users/mactty/project/opencv/OpenCV-android-sdk/sdk/etc/lbpcascades/lbpcascade_frontalface.xml";
    ...
    while (i < 100) {
        ...
        for (const Rect &face : faces) {
            ...
            char p[100];
            sprintf(p, "/Users/mactty/project/opencv/face/train/zhy/%d.jpg", i++);
            //把mat写出为jpg文件
            imwrite(p, m);
            m.release();
        }
...
void face_detect() {
    //使用官方训练的模型
    String path = "/Users/mactty/project/opencv/face/train/data/cascade.xml";
